...
const Stat = () => {
    ...
    return (
        <div
            style={{
                background: 'url("/pngtree-colo.jpg")',
                        ...
                        {modalData.length === 0 ? (
                            ...
                            <>
                                        ...
                                        {modalData.map((admin) => (
                                            <Col md={6} key={admin._id} className="mb-3">
                                                <Card className="shadow-sm border-0 h-100">
                                                    <Card.Body>
                                                        <Card.Title className="text-dark">{admin.AliasId}</Card.Title>
                                ...
                                {modalTitle === 'Counselors & Psychologists' && (
                                    <Row>
                                        {modalData.map((counselor) => (
                                            <Col md={6} key={counselor._id} className="mb-3">
                                                <Card className="shadow-sm border-0 h-100">
                                                    <Card.Body>
                                                        <Card.Title className="text-primary">{counselor.FullName}</Card.Title>
                                                        <Card.Subtitle className="mb-2 text-muted text-capitalize">{counselor.Role}</Card.Subtitle>
                                                        <div><strong>Alias ID:</strong> {counselor.AliasId}</div>
                                                        <div><strong>Email:</strong> {counselor.Email}</div>
                                                        <div><strong>Phone:</strong> {counselor.Phone}</div>
                                                        <div><strong>Specialization:</strong> {counselor.Specialization}</div>
                                                        <div><strong>Credentials:</strong> {counselor.Credentials}</div>
                                                        <div><strong>Status:</strong>{' '}
                                                            <span className={`badge ${counselor.Status === 'active' ? 'bg-success' : 'bg-secondary'}`}>
                                                                {counselor.Status}
                                                            </span>
                                                        </div>
                                                        <div>
                                                            ...
                                                            <ul className="mb-0">
                                                                {counselor.AvailabilitySlots.map((slot, idx) => (
                                            ...
                                            <Col md={6} key={student._id} className="mb-3">
                                                <Card className="shadow-sm border-0 h-100">
                                                    <Card.Body>
                                                        ...
                                                        <div><strong>Language:</strong> {student.Language || 'N/A'}</div>
                                                        <div><strong>Status:</strong>{' '}
